...
template <class T> int* adjacencyWDigraph<T>::partialTour;
template <class T> int* adjacencyWDigraph<T>::bestTourSoFar;
template <class T> T adjacencyWDigraph<T>::costOfBestTourSoFar;
template <class T> T adjacencyWDigraph<T>::costOfPartialTour;
